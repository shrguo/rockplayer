 ...
 * Original file: E:\\AndriodWorkPlace\\rockplayer\\src\\com\\xmobileapp\\rockplayer\\PlayerServiceInterface.aidl
 */
...
/**
 * Cast an IBinder object into an com.xmobileapp.rockplayer.PlayerServiceInterface interface,
...
@Override public void play(int albumCursorPosition, int songCursorPosition) throws android.os.RemoteException
{
...
@Override public int getPlayingPosition() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public void setShuffle(boolean shuffle) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public int getAlbumCursorPosition() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int getSongCursorPosition() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public boolean setAlbumCursorPosition(int position) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public boolean setSongCursorPosition(int position) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public void forward() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void reverse() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void setPlaylist(long playlist) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void setRecentPeriod(int period) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void resetAlbumCursor() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void reloadCursors() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void setScrobbleDroid(boolean val) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_playNext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_stop = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getPlayingPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getDuration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setShuffle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getAlbumCursorPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getSongCursorPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_setAlbumCursorPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_setSongCursorPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_forward = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_reverse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_seekTo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_setPlaylist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_setRecentPeriod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_resetAlbumCursor = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_reloadCursors = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_destroy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setScrobbleDroid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
}
